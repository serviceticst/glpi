#------------------------------------------------
#  INSTALACAO DO GLPI NA ULTIMA VERSAO ESTAVEL NO DEBIAN 12 BOOKWORM  (PADRAO REMI REDHAT)
#
#   DOWNLOAD: https://gemmei.ftp.acc.umu.se/debian-cd/current/amd64/iso-cd/debian-12.0.0-amd64-netinst.iso
#------------------------------------------------
#
...
#
#           YouTube: https://www.youtube.com/watch?v=tcey2zsand4&t
#-------------------------------------------------
#
#
clear
