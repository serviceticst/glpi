# 🧩 Scripts para uso na ferramenta do GLPI
- Este repositório contém scripts do GLPI desenvolvidos pela equipe da Service TIC.
...
## 🧩 Scripts for use with the GLPI tool
